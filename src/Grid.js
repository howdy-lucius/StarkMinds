            ...
            <div className="block-decorative block-25 block block-title-row">
                ...
                <div className="block-100 what-we-do">
                    ...
                    <div className="block block-content block-75">
                        <p>By studying complimentary ecoystems and carefully selecting partners we can make calm, catchy, calculated decision</p>
                    </div>
                </div>
                ...
                <Block title="Future" svg="asterick" num="3">
